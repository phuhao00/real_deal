...
export default async function NotificationsPage({ searchParams }: { searchParams?: { q?: string } }){
  ...
  return (
    <FeedLayout trending={data.products} news={data.companies} title="通知" filters={filters}>
      <Composer />
