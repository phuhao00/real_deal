...
export default async function BookmarksPage({ searchParams }: { searchParams?: { q?: string } }){
  ...
  return (
    <FeedLayout trending={data.products} news={data.companies} title="收藏" filters={filters}>
      <Composer />
